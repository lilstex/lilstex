...
```
Backend:      NestJS · Laravel · Node.js · TypeScript · PHP · Express.js
Databases:    MongoDB · PostgreSQL · MySQL · Redis
ORMs:         Mongoose · Prisma · TypeORM · Eloquent
DevOps:       Docker · GitHub Actions · Azure · AWS · Digital Ocean · Nginx
Payments:     Stripe · Paystack · Lemon Squeezy
AI:           OpenAI API · Zod Structured Outputs · Puppeteer
...
| Company | Role | Stack |
|---------|------|-------|
| ShotNub Solutions | Founder & Lead Backend Engineer | NestJS, MongoDB, OpenAI, Docker |
| DPAnalytic Solutions | DevOps Engineer | Laravel, NestJS, MySQL, Azure, Docker |
| Payraty | Backend Engineer | Laravel, MySQL, AWS (EC2, S3) |
| Alkademy | DevOps Engineer | Laravel, Digital Ocean, GitHub Actions |

---

### Get in Touch

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://linkedin.com/in/emmanuelmbagwu)
[![Website](https://img.shields.io/badge/Website-0a2540?style=flat&logo=google-chrome&logoColor=white)](https://shotnubsolutions.com)
[![Email](https://img.shields.io/badge/Email-635bff?style=flat&logo=gmail&logoColor=white)](mailto:hello@shotnubsolutions.com)
```
